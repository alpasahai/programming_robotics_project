...
#tidying atlas_controller
from fire_control_helper import handle_fire_command
from adapative_observation_helper import handle_sensor_updates
from adapative_observation_helper import handle_adaptive_observation
...
while robot.step(timestep) != -1:
    ...
    last_prerotate_sector = handle_adaptive_observation(
        launch_latch,
        ground_hit_link,
        bullet_hit_link,
        cue_link,
    ...
    handle_fire_command(fsm, bullet, pan_sensor, log,) #functions fire_control_helper.py
