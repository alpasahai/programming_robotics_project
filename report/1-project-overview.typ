...
Autonomous Tracking and Laser Aiming System (ATLAS) is a simulated fire-control system
that detects, tracks, and neutralises airborne threats without human input, operating in
an outdoor Webots environment. It is split into two collaborative units: a Search Radar
that sweeps a wide area with a wide-beam radar sensor, and a turret-mounted Fire-Control
Radar (FCR) carrying a narrow-beam radar and projectile launcher. The two units
coordinate over emitter/receiver pairs, with rotational motors driving the search sweep
and the FCR's pan/tilt turret.
